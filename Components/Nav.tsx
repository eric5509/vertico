...
export default function Nav() {
  ...
  return (
    <div className="">
      <p
        className={`fixed top-1/2 left-5 text-base z-[1000] font-semibold vertical-lr 'text-black' `}
      >
        Vertico
      </p>
      <div className="fixed h-20 bg-white lg:bg-transparent z-[20000] px-3 flex items-center  w-screen top-0 left-0">
        <div className="container flex justify-between items-center">
          <div className="flex items-center gap-3">
            <IoDiamondOutline className="text-6xl text-[blue] stroke-1" />
          </div>
          <div
          ...
          >
            ...
            <div onClick={() => setDropdown(true)} className="hidden cursor-pointer lg:flex items-center gap-3">
